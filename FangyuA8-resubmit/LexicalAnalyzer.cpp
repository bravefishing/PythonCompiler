...
//check for whether is comment or not!!!  comment is not token!!!!
 ...
 /*   else if(largeString[next]=='{')
    ...
    else if(isalpha(largeString[next]))
    {
        ...
        int m=0;
        OneString a[22]={"PROGRAM","PROCEDURE","FUNCTION","VAR","BEGIN","END","IF","THEN","ELSE","WHILE","DO","REAL","INTEGER","CHAR","OR","DIV","MOD","AND","CONST","READ","WRITE","WRITELN"};
        for(int i=0;i<22;i++)
        {
...
void LexicalAnalyzer::Display(int t,int lineNum)
{
    switch(t)
    {
        ...
        case literalt  :       cout<<"literalt  \t"<<lexeme<<"\t"<<"literalNum"<<endl;break;
